            ...
            <nav class="site-navigation text-right ml-auto " role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                <li><a href="{{ route('beranda') }}" 
                    ...
                    nav-link">Beranda</a></li>
                <li><a href="{{ route('peta') }}" class="{{Route::currentRouteNamed('peta') ? 'active' : ''}}
                    nav-link">
                    Peta Interaktif</a>
                </li>
                ...
                <li>
                  <a href="#about-section" class="{{Route::currentRouteNamed('rekomendasi') ? 'active' : ''}} 
                  nav-link"
                  >Rekomendasi</a>

                </li>

                <li><a href="{{ route('artikel') }}" class="{{Route::currentRouteNamed('artikel') ? 'active' : ''}}
                    nav-link"
                    >Berita dan Artikel</a>
                </li>

                <li><a href="{{ route('kontak') }}" class="{{Route::currentRouteNamed('kontak') ? 'active' : ''}} 
                    nav-link">
                    Kontak Kami
                </a></li>
